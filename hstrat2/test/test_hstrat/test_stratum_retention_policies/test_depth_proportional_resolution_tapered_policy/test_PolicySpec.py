...
def test_eq(depth_proportional_resolution):
    ...
    assert spec == spec
    assert spec == depth_proportional_resolution_tapered_policy.PolicySpec(depth_proportional_resolution)
    assert not spec == depth_proportional_resolution_tapered_policy.PolicySpec(depth_proportional_resolution + 1)
