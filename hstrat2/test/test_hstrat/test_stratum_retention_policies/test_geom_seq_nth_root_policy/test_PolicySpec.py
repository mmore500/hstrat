...
def test_eq(degree, interspersal):
    ...
    assert not spec == geom_seq_nth_root_policy.PolicySpec(degree, interspersal + 1)
    assert not spec == geom_seq_nth_root_policy.PolicySpec(degree + 1, interspersal)
    assert not spec == geom_seq_nth_root_policy.PolicySpec(degree + 1, interspersal + 1)
