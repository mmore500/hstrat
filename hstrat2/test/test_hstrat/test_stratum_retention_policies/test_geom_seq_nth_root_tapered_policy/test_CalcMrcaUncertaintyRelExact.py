...
def test_policy_consistency(degree, interspersal, time_sequence):
    ...
    spec = policy.GetSpec()
    instance = geom_seq_nth_root_tapered_policy.CalcMrcaUncertaintyRelExact(spec)
...
def test_eq(degree, interspersal):
    ...
    assert instance == geom_seq_nth_root_tapered_policy.CalcMrcaUncertaintyRelExact(spec)
