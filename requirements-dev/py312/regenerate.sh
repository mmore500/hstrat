...
python3 -m uv pip compile --python-version=3.11 ../../pyproject.toml --extra docs --extra release --extra testing --extra pinned_jit -o requirements-all.txt
...
python3 -m uv pip compile --python-version=3.11 ../../pyproject.toml --extra testing --extra pinned_jit -o requirements-testing.txt
