...
python3.7 -m piptools compile ../../pyproject.toml --extra pinned_dependencies_py37 --extra pinned_jit --extra docs --extra release --extra testing_py37 -o requirements-all.txt
...
python3.7 -m piptools compile ../../pyproject.toml --extra pinned_dependencies_py37 --extra pinned_jit -o requirements-jit.txt
...
python3.7 -m piptools compile ../../pyproject.toml --extra pinned_dependencies_py37 --extra pinned_jit --extra testing_py37 -o requirements-testing.txt
