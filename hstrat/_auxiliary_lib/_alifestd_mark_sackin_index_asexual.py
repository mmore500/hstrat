...
def alifestd_mark_sackin_index_asexual(
    ...
    Nodes with fewer or more than 2 children (unifurcations, polytomies) do not
    contribute to depth accumulation. For trees with polytomies, consider using
    `alifestd_mark_sackin_index_generalized_asexual` instead.
