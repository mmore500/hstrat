...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser = _add_parser_base(
        parser=parser,
        dfcli_module="hstrat._auxiliary_lib._alifestd_mark_clade_leafcount_ratio_sister_asexual",
...
if __name__ == "__main__":
    ...
    with log_context_duration(
        "hstrat._auxiliary_lib._alifestd_mark_clade_leafcount_ratio_sister_asexual", logging.info
    ):
        _run_dataframe_cli(
            base_parser=parser,
