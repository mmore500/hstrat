...
#include <hstrat/stratum_retention_strategy/stratum_retention_algorithms/fixed_resolution_algo/scry/CalcNumStrataRetainedExactFtor.hpp>

namespace py = pybind11;
namespace algo = hstrat::fixed_resolution_algo;

using self_t = algo::CalcNumStrataRetainedExactFtor;

PYBIND11_MODULE(_CalcNumStrataRetainedExactNative, m) {
  ...
  py::class_<self_t>(
    m,
    "CalcNumStrataRetainedExactNative"
  )
