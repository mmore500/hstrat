...
#include <hstrat/stratum_retention_strategy/stratum_retention_algorithms/fixed_resolution_algo/scry/CalcMrcaUncertaintyRelExactFtor.hpp>

namespace py = pybind11;
namespace algo = hstrat::fixed_resolution_algo;

using self_t = algo::CalcMrcaUncertaintyRelExactFtor;

PYBIND11_MODULE(_CalcMrcaUncertaintyRelExactNative, m) {
  ...
  py::class_<self_t>(
    m,
    "CalcMrcaUncertaintyRelExactNative"
  )
