...
#include <hstrat/stratum_retention_strategy/stratum_retention_algorithms/fixed_resolution_algo/scry/CalcMrcaUncertaintyAbsExactFtor.hpp>

namespace py = pybind11;
namespace algo = hstrat::fixed_resolution_algo;

using self_t = algo::CalcMrcaUncertaintyAbsExactFtor;

PYBIND11_MODULE(_CalcMrcaUncertaintyAbsExactNative, m) {
  ...
  py::class_<self_t>(
    m,
    "CalcMrcaUncertaintyAbsExactNative"
  )
