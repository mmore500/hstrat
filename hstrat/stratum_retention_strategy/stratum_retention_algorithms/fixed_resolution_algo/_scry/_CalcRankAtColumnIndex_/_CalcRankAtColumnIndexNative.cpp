...
#include <hstrat/stratum_retention_strategy/stratum_retention_algorithms/fixed_resolution_algo/scry/CalcRankAtColumnIndexFtor.hpp>

namespace py = pybind11;
namespace algo = hstrat::fixed_resolution_algo;

using self_t = algo::CalcRankAtColumnIndexFtor;

PYBIND11_MODULE(_CalcRankAtColumnIndexNative, m) {
