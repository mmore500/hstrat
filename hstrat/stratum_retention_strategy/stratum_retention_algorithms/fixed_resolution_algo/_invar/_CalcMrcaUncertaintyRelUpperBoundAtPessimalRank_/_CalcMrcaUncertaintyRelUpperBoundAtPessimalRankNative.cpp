...
#include <hstrat/stratum_retention_strategy/stratum_retention_algorithms/fixed_resolution_algo/invar/CalcMrcaUncertaintyRelUpperBoundAtPessimalRankFtor.hpp>
...
using self_t = algo::CalcMrcaUncertaintyRelUpperBoundAtPessimalRankFtor;

PYBIND11_MODULE(_CalcMrcaUncertaintyRelUpperBoundAtPessimalRankNative, m) {
  ...
  py::class_<self_t>(
    m,
    "CalcMrcaUncertaintyRelUpperBoundAtPessimalRankNative"
  )
