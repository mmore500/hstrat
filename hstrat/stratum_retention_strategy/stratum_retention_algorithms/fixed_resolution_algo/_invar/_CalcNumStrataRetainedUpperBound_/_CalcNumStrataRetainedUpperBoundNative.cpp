...
#include <hstrat/stratum_retention_strategy/stratum_retention_algorithms/fixed_resolution_algo/invar/CalcNumStrataRetainedUpperBoundFtor.hpp>
...
using self_t = algo::CalcNumStrataRetainedUpperBoundFtor;

PYBIND11_MODULE(_CalcNumStrataRetainedUpperBoundNative, m) {
  ...
  py::class_<self_t>(
    m,
    "CalcNumStrataRetainedUpperBoundNative"
  )
