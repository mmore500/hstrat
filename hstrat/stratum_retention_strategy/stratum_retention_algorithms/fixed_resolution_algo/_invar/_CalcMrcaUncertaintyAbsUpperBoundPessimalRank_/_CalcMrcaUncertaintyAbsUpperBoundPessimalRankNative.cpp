...
using self_t = algo::CalcMrcaUncertaintyAbsUpperBoundPessimalRankFtor;

PYBIND11_MODULE(_CalcMrcaUncertaintyAbsUpperBoundPessimalRankNative, m) {
  ...
  py::class_<self_t>(
    m,
    "CalcMrcaUncertaintyAbsUpperBoundPessimalRankNative"
  )
