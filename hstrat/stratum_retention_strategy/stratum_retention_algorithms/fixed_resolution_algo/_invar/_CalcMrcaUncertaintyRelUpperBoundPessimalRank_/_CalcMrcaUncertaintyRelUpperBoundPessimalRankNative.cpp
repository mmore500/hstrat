...
#include <hstrat/stratum_retention_strategy/stratum_retention_algorithms/fixed_resolution_algo/invar/CalcMrcaUncertaintyRelUpperBoundPessimalRankFtor.hpp>
...
using self_t = algo::CalcMrcaUncertaintyRelUpperBoundPessimalRankFtor;

PYBIND11_MODULE(_CalcMrcaUncertaintyRelUpperBoundPessimalRankNative, m) {
  ...
  py::class_<self_t>(
    m,
    "CalcMrcaUncertaintyRelUpperBoundPessimalRankNative"
  )
