...
#include <hstrat/stratum_retention_strategy/stratum_retention_algorithms/fixed_resolution_algo/invar/CalcMrcaUncertaintyAbsUpperBoundFtor.hpp>
...
using self_t = algo::CalcMrcaUncertaintyAbsUpperBoundFtor;

PYBIND11_MODULE(_CalcMrcaUncertaintyAbsUpperBoundNative, m) {
  ...
  py::class_<self_t>(
    m,
    "CalcMrcaUncertaintyAbsUpperBoundNative"
  )
