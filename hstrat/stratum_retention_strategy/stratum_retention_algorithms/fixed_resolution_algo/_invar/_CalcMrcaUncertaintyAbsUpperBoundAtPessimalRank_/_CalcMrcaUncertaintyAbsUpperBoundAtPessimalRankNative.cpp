...
#include <hstrat/stratum_retention_strategy/stratum_retention_algorithms/fixed_resolution_algo/invar/CalcMrcaUncertaintyAbsUpperBoundAtPessimalRankFtor.hpp>
...
using self_t = algo::CalcMrcaUncertaintyAbsUpperBoundAtPessimalRankFtor;

PYBIND11_MODULE(_CalcMrcaUncertaintyAbsUpperBoundAtPessimalRankNative, m) {
  ...
  py::class_<self_t>(
    m,
    "CalcMrcaUncertaintyAbsUpperBoundAtPessimalRankNative"
  )
...
cfg['extra_compile_args'] = ['-std=c++2a', '-fconcepts','-fcoroutines', '-fPIC', '-DFMT_HEADER_ONLY']
