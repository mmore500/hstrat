...
from ._calc_definitive_min_ranks_since_first_retained_disparity_between import (
    calc_definitive_min_ranks_since_first_retained_disparity_between,
)
from ._calc_definitive_min_ranks_since_last_retained_commonality_between import (
    calc_definitive_min_ranks_since_last_retained_commonality_between,
)
