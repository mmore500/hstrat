...
if __name__ == "__main__":
    ...
    print(
        ...
        hstrat.calc_ranks_since_mrca_bounds_with(descendant1a, descendant1b),
    )
    print(
        "   ",
        "estimate descendant1b generations since MRCA with descendant1a?",
        hstrat.calc_ranks_since_mrca_bounds_with(descendant1b, descendant1a),
    )
    print(
        "estimate generation of MRCA between descendant1a and descendant1b?",
        hstrat.calc_rank_of_mrca_bounds_between(descendant1a, descendant1b),
    )
