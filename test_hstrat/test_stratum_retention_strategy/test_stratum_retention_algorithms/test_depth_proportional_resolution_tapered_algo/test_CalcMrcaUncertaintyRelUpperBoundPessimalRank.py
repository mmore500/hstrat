...
@pytest.mark.parametrize(
    "impl",
    depth_proportional_resolution_tapered_algo._invar._CalcMrcaUncertaintyRelUpperBoundPessimalRank_.impls,
)
@pytest.mark.parametrize(
                ...
                len(
                    {
                        ...
                        for impl in depth_proportional_resolution_tapered_algo._invar._CalcMrcaUncertaintyRelUpperBoundPessimalRank_.impls
                    }
                )
                == 1
            )
