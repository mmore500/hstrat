...
@pytest.mark.parametrize(
    "impl",
    geom_seq_nth_root_algo._invar._CalcMrcaUncertaintyAbsUpperBound_.impls,
)
@pytest.mark.parametrize(
    "degree",
    [
                    ...
                    len(
                        {
                            ...
                            for impl in geom_seq_nth_root_algo._invar._CalcMrcaUncertaintyAbsUpperBound_.impls
                        }
                    )
                    == 1
                )
