...
@pytest.mark.parametrize(
    "impl",
    geom_seq_nth_root_tapered_algo._scry._CalcNumStrataRetainedExact_.impls,
)
@pytest.mark.parametrize(
    "degree",
    [
            ...
            len(
                {
                    ...
                    for impl in geom_seq_nth_root_tapered_algo._scry._CalcNumStrataRetainedExact_.impls
                }
            )
            == 1
        )
