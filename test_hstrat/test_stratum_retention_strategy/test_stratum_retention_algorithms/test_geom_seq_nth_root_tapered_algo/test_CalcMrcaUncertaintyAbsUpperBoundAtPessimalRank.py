...
@pytest.mark.parametrize(
    "impl",
    geom_seq_nth_root_tapered_algo._invar._CalcMrcaUncertaintyAbsUpperBoundAtPessimalRank_.impls,
)
@pytest.mark.parametrize(
    "degree",
    [
                ...
                len(
                    {
                        ...
                        for impl in geom_seq_nth_root_tapered_algo._invar._CalcMrcaUncertaintyAbsUpperBoundAtPessimalRank_.impls
                    }
                )
                == 1
            )
