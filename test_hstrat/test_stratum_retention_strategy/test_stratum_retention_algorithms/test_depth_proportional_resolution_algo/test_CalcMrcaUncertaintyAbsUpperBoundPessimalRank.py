...
@pytest.mark.parametrize(
    "impl",
    depth_proportional_resolution_algo._invar._CalcMrcaUncertaintyAbsUpperBoundPessimalRank_.impls,
)
@pytest.mark.parametrize(
                ...
                len(
                    {
                        ...
                        for impl in depth_proportional_resolution_algo._invar._CalcMrcaUncertaintyAbsUpperBoundPessimalRank_.impls
                    }
                )
                == 1
            )
