...
@pytest.mark.parametrize(
    "impl",
    depth_proportional_resolution_algo._invar._CalcMrcaUncertaintyRelUpperBound_.impls,
)
@pytest.mark.parametrize(
                    ...
                    len(
                        {
                            ...
                            for impl in depth_proportional_resolution_algo._invar._CalcMrcaUncertaintyRelUpperBound_.impls
                        }
                    )
                    == 1
                )
