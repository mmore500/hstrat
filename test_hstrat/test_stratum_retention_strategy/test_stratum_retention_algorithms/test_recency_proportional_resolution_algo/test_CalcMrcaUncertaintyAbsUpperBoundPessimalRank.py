...
@pytest.mark.parametrize(
    "impl",
    recency_proportional_resolution_algo._invar._CalcMrcaUncertaintyAbsUpperBoundPessimalRank_.impls,
)
@pytest.mark.parametrize(
                ...
                len(
                    {
                        ...
                        for impl in recency_proportional_resolution_algo._invar._CalcMrcaUncertaintyAbsUpperBoundPessimalRank_.impls
                    }
                )
                == 1
            )
