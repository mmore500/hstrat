...
from hstrat._auxiliary_lib import alifestd_set_root_ancestor_token


@pytest.mark.parametrize("mutate", [True, False])
@pytest.mark.parametrize("token", ["none", "None", ""])
def test_alifestd_set_root_ancestor_token_with_empty(mutate, token):
    ancestor_list_series = pd.Series(dtype=str)
    expected_output = pd.Series(dtype=str)
    output = alifestd_set_root_ancestor_token(
...
def test_alifestd_set_root_ancestor_token_with_singleton(
...
@pytest.mark.parametrize("tokenfrom", ["none", "None", ""])
@pytest.mark.parametrize("tokento", ["none", "None", ""])
def test_alifestd_set_root_ancestor_token_with_single_root1(
    mutate, tokenfrom, tokento
):
...
@pytest.mark.parametrize("tokenfrom", ["none", "None", ""])
@pytest.mark.parametrize("tokento", ["none", "None", ""])
def test_alifestd_set_root_ancestor_token_with_single_root2(
    mutate, tokenfrom, tokento
):
...
@pytest.mark.parametrize("tokenfrom", ["none", "None", ""])
@pytest.mark.parametrize("tokento", ["none", "None", ""])
def test_alifestd_set_root_ancestor_token_with_multiple_roots1(
    mutate, tokenfrom, tokento
):
...
@pytest.mark.parametrize("tokenfrom", ["none", "None", ""])
@pytest.mark.parametrize("tokento", ["none", "None", ""])
def test_alifestd_set_root_ancestor_token_with_multiple_roots2(
    mutate, tokenfrom, tokento
):
    ancestor_list_series = pd.Series(
...
@pytest.mark.parametrize("tokenfrom", ["none", "None", ""])
@pytest.mark.parametrize("tokento", ["none", "None", ""])
def test_alifestd_set_root_ancestor_token_with_multiple_roots3(
    mutate, tokenfrom, tokento
):
    ancestor_list_series = pd.Series(
...
@pytest.mark.parametrize("tokenfrom", ["none", "None", ""])
@pytest.mark.parametrize("tokento", ["none", "None", ""])
def test_alifestd_set_root_ancestor_token_with_multiple_roots4(
    mutate, tokenfrom, tokento
):
    ancestor_list_series = pd.Series(
