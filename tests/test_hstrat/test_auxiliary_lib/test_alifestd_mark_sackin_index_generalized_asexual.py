...
def test_fuzz(phylogeny_df: pd.DataFrame):
    ...
    result = alifestd_mark_sackin_index_generalized_asexual(phylogeny_df)
...
def test_empty():
    res = alifestd_mark_sackin_index_generalized_asexual(alifestd_make_empty())
...
def test_simple_chain(mutate: bool):
    ...
    Generalized Sackin accumulates through all nodes.
    ...
    result_df = alifestd_mark_sackin_index_generalized_asexual(
        phylogeny_df,
        mutate=mutate,
    )
...
def test_polytomy_balanced(mutate: bool):
    ...
    Generalized Sackin handles polytomies.
